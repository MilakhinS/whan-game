...
const inp = { background:'rgba(255,255,255,0.04)', border:'1px solid rgba(201,168,76,0.22)', borderRadius:12, padding:'11px 14px', color:'#e8d5a3', fontSize:16, outline:'none', width:'100%' } as const
const btn = (active=true) => ({ padding:'12px 24px', borderRadius:12, border:`1px solid ${active?GOLD:'rgba(201,168,76,0.2)'}`, background:active?'linear-gradient(135deg,#3d2a00,#6b4a0a,#3d2a00)':'transparent', color:active?'#f0d080':'#5a4820', cursor:active?'pointer':'not-allowed', fontSize:16, fontWeight:600, letterSpacing:'0.04em', width:'100%', boxShadow:active?'0 2px 16px rgba(201,168,76,0.25)':'none', transition:'all 0.18s' })
    ...
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:20, position:'relative' }}>
      ...
      <div style={{ ...panel, padding:'36px 28px', width:'100%', maxWidth:400, position:'relative', zIndex:1 }}>
        ...
        <div style={{ textAlign:'center', marginBottom:28 }}>
          ...
          <div style={{ fontSize:16, color:'rgba(201,168,76,0.4)', letterSpacing:3, marginTop:4 }}>by Milakhin Studio</div>
        </div>

        {/* Google button */}
        <button onClick={handleGoogle} disabled={loading} style={{ width:'100%', padding:'13px', borderRadius:12, cursor:'pointer', fontFamily:'inherit', fontSize:16, fontWeight:600, border:'1px solid rgba(201,168,76,0.25)', background:'rgba(255,255,255,0.05)', color:'#e8d5a3', display:'flex', alignItems:'center', justifyContent:'center', gap:10, marginBottom:16, transition:'all 0.18s' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:16 }}>
          ...
          <div style={{ fontSize:17, color:'rgba(201,168,76,0.3)' }}>или email</div>
          <div style={{ flex:1, height:1, background:'rgba(201,168,76,0.15)' }}/>
        </div>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
          ...
          {error && <div style={{ fontSize:16, color:'#e74c3c', textAlign:'center' }}>{error}</div>}
        ...
        <div style={{ textAlign:'center', marginTop:20, fontSize:17, color:'rgba(201,168,76,0.3)', lineHeight:1.7 }}>
